...
const Activity = () => {
  ...
  const handleSearch = async (e) => {
    try {
      ...
      const results = await GetMyActivities(e.target.value);
  ...
  const handleGetUpcommingActivity = async () => {
    try {
      ...
      const venueNames = activitiesResponse.upcoming.map(
        (activity) => activity.venue_name
      );
                  ...
                  <div className="tw-flex tw-justify-between -tw-items-center">
                    {userRole !== "customer" && (
                      <Button
                        onClick={() => {
                          toggleModal();
                          handleGetUpcommingActivity();
                        }}
                        className="mr-2 tw-text-black"
                      >
                        Create Activity
                      </Button>
                    )}
                    ...
                    <div className="tw-flex items-center ">
                      ...
                      <input
                        ...
                        placeholder="Search by name or description"
                        className="tw-mr-2 tw-w-64 tw-p-2 tw-rounded-md"
                      />
              ...
              {modalLoading ? (
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                    <DropdownToggle caret>Select Venue</DropdownToggle>
                    <DropdownMenu>
                  ...
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setParticipantsLimit(Number(e.target.value))
                      }
                      required
                    />
                  </FormGroup>

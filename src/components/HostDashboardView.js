...
const HostDashboardView = () => {
    ...
    const [venueBookingsPerPage] = useState(2);
    const [activitiesPerPage] = useState(2);
    ...
    const renderVenueBooking = (booking) => {
        return (
            <div key={booking._id} className="tw-bg-white tw-p-4 tw-mb-4 tw-shadow-lg tw-rounded-lg">
                ...
                <p className="tw-text-sm tw-text-gray-600">User: {booking.user.firstName} {booking.user.lastName}</p>
                <p className="tw-text-sm tw-text-gray-600">Email: {booking.user.email}</p>
    ...
    const renderActivityBooking = (activity) => {
        return (
            <div key={activity.activityName} className="tw-bg-white tw-p-4 tw-mb-4 tw-shadow-lg tw-rounded-lg">
                <h5 className="tw-font-semibold tw-text-lg tw-text-gray-800">{activity.activityName}</h5>
                <p className="tw-text-sm tw-text-gray-600">Participants Count: {activity.participantsCount}</p>
            </div>
        );
    };
        ...
        <div className="tw-container tw-mx-auto tw-px-4 tw-py-8">
            ...
            <Card className="tw-grid  tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4 tw-p-4 tw-bg-blue-200" >
                ...
                <div>
                    ...
                    <h3 className="tw-text-2xl tw-text-black tw-font-semibold tw-mb-4">Past Venue Bookings</h3>
                    <hr className="tw-my-2 tw-border-gray-300" /> 
                    <br></br>

                    {dashboardData.venueBookings.past.length === 0 ? (
                        <p className="tw-text-lg tw-text-gray-500 tw-font-semibold">No past venue bookings found.</p>
                    ) : (
                ...
                <div>
                    ...
                    <h3 className="tw-text-2xl tw-text-black tw-font-semibold tw-mb-4">Upcoming Venue Bookings</h3>
                    <hr className="tw-my-2 tw-border-gray-300" /> 
                    <br></br>

                    {dashboardData.venueBookings.upcoming.length === 0 ? (
                        <p className="tw-text-lg tw-text-gray-500 tw-font-semibold">No upcoming venue bookings found.</p>
                    ) : (
                        <div style={{ maxHeight: "400px", overflowY: "auto" }}>
            ...
            <Card className="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4 tw-p-4 tw-bg-blue-200 ">
                ...
                <div>
                    ...
                    <h3 className="tw-text-2xl tw-text-black tw-font-semibold ">Past Activities</h3>
                    <hr className="tw-my-2 tw-border-gray-300" /> 
                    <br></br>
                ...
                <div>
                    <hr className="tw-my-2 tw-border-gray-300" /> 
                    <h3 className="tw-text-2xl tw-text-black tw-font-semibold tw4-mb-">Upcoming Activities</h3>
                    <hr className="tw-my-2 tw-border-gray-300" /> 
                    <br></br>
